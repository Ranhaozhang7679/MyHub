...
namespace Luster.SimDevice.MotionCard.LC
{
    public class ecat_motion1
    {
        ...
        //[DllImport("ecat_motion.dll", CallingConvention = CallingConvention.Cdecl)]
        //public static extern short M_SetCardOrder(short sOrder, short card = 0);
        ...
        //停止轴运动
        [DllImport("ecat_motion.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern short M_Stop(ulong mask, ulong option, short card);
        ...
        [DllImport("ecat_motion.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern short M_PtStart(ulong mask, ulong option, short card);
        ...
        ********************************************************/
        ...
        [DllImport("ecat_motion.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern short M_Get_Digital_Input(ref short chnNum, ref short pValue, short card = 0);

        [DllImport("ecat_motion.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern short M_Get_Digital_Output(ref short chnNum, ref short pValue, short card = 0);

        [DllImport("ecat_motion.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern short M_Set_Digital_Output(short chnNum, ref ushort pValue, short card = 0);
        ...
        ********************************************************/
        ...
        [DllImport("ecat_motion.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern short M_GetValues(short card = 0);

        [DllImport("ecat_motion.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern short M_SetObjectCenterBias(short crd, double biasX, double biasY, double biasU, short card = 0);

        [DllImport("ecat_motion.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern short M_Mul_Servo_On_Quickly(short axisNum, ref short axis, short interval, ref ulong servoState, short card = 0);
