...
{
    public class ResetStation : StationFunction, IResetStation
    {
        ...
        /// 属于类型
        /// </summary>
        public HomeType HomeType => HomeType.Reset;
        ...
        {
            this.Icon = "\xe64d";
            this.Tips = "复位工站，用于已经回过零的机台，将轴回到安全位置";
        }
        ...
        private void MotionRunEngine_ProgressEvent(TaskFlow.Motion.IMotionModule obj)
        {
            ...
            {
                _currentVal++;
                HomeProgressEvent?.Invoke(total, ref _currentVal, $"模块:{obj.Alias}复位完成");
            }
        }
    }
}