...
* 类 名 称:       CTS
* 机器名称:       L05123-NB
* 命名空间:       Luster.SimDevice.Light.CTS
* 文 件 名:       CTS.cs
* 创建时间:       2022/6/8 13:17:12
* 作    者:       L05123
* 所属部门：      系统集成部
...
* 唯一标识：      2a365568-b483-43b3-9fd5-40e3680193d5
* 登录用户:       darkliu
* 所 属 域:       LUSTERINC
* 创建年份:       2022
* 修改时间:		  2022/6/8 13:17:12
* 修 改 人:		  L05123
************************************************************************************/
#endregion
...
namespace Luster.SimDevice.Light.CST
{
    ...
    class CSTControllerAPI
    {
        ...
        private static extern unsafe int CST_ConnectIP(string ipAddress, int mTimeOut, CSTControllerHandleType* CSTControllerHandle);

        [DllImport(CSTContorllerDll, CallingConvention = CallingConvention.Cdecl)]
        private static extern unsafe int CST_DestroyIpConnection(CSTControllerHandleType CSTControllerHandle);

        [DllImport(CSTContorllerDll, CallingConvention = CallingConvention.Cdecl)]
        private static extern unsafe int CST_CreateSerialPort(int serialPortIndex, CSTControllerHandleType* CSTControllerHandle);

        [DllImport(CSTContorllerDll, CallingConvention = CallingConvention.Cdecl)]
        private static extern unsafe int CST_ReleaseSerialPort(CSTControllerHandleType CSTControllerHandle);

        [DllImport(CSTContorllerDll, CallingConvention = CallingConvention.Cdecl)]
        private static extern unsafe int CST_GetDigitalValue(int* intensity, int ChannelIndex, CSTControllerHandleType CSTControllerHandle);

        [DllImport(CSTContorllerDll, CallingConvention = CallingConvention.Cdecl)]
        private static extern unsafe int CST_SetDigitalValue(int ChannelIndex, int intensity, CSTControllerHandleType CSTControllerHandle);

        [DllImport(CSTContorllerDll, CallingConvention = CallingConvention.Cdecl)]
        private static extern unsafe int CST_SetMulDigitalValue(MulDigValItem[] MulDigValArray, int length, CSTControllerHandleType CSTControllerHandle);

        [DllImport(CSTContorllerDll, CallingConvention = CallingConvention.Cdecl)]
        private static extern unsafe int CST_GetStrobeValue(int* strobeValue, int ChannelIndex, CSTControllerHandleType CSTControllerHandle);

        [DllImport(CSTContorllerDll, CallingConvention = CallingConvention.Cdecl)]
        private static extern unsafe int CST_SetStrobeValue(int ChannelIndex, int strobeValue, CSTControllerHandleType CSTControllerHandle);

        [DllImport(CSTContorllerDll, CallingConvention = CallingConvention.Cdecl)]
        private static extern unsafe int CST_SetMulStrobeValue(MulStbValItem[] MulStbValArray, int length, CSTControllerHandleType CSTControllerHandle);

        [DllImport(CSTContorllerDll, CallingConvention = CallingConvention.Cdecl)]
        private static extern unsafe int CST_GetLightDelayValue(int* lightDelayValue, int ChannelIndex, CSTControllerHandleType CSTControllerHandle);

        [DllImport(CSTContorllerDll, CallingConvention = CallingConvention.Cdecl)]
        private static extern unsafe int CST_SetLightDelayValue(int ChannelIndex, int lightDelayValue, CSTControllerHandleType CSTControllerHandle);

        [DllImport(CSTContorllerDll, CallingConvention = CallingConvention.Cdecl)]
        private static extern unsafe int CST_SetMulLightDelayValue(MulLigDelValItem[] MulLigDelValArray, int length, CSTControllerHandleType CSTControllerHandle);

        [DllImport(CSTContorllerDll, CallingConvention = CallingConvention.Cdecl)]
        private static extern unsafe int CST_GetCameraDelayValue(int* cameraDelayValue, int ChannelIndex, CSTControllerHandleType CSTControllerHandle);

        [DllImport(CSTContorllerDll, CallingConvention = CallingConvention.Cdecl)]
        private static extern unsafe int CST_SetCameraDelayValue(int ChannelIndex, int cameraDelayValue, CSTControllerHandleType CSTControllerHandle);

        [DllImport(CSTContorllerDll, CallingConvention = CallingConvention.Cdecl)]
        private static extern unsafe int CST_SetMulCameraDelayValue(MulCamDelValItem[] MulCamDelValArray, int length, CSTControllerHandleType CSTControllerHandle);

        [DllImport(CSTContorllerDll, CallingConvention = CallingConvention.Cdecl)]
        private static extern unsafe int CST_GetIntCycleValue(int* intCycleValue, CSTControllerHandleType CSTControllerHandle);

        [DllImport(CSTContorllerDll, CallingConvention = CallingConvention.Cdecl)]
        private static extern unsafe int CST_SetIntCycleValue(int intCycleValue, CSTControllerHandleType CSTControllerHandle);

        [DllImport(CSTContorllerDll, CallingConvention = CallingConvention.Cdecl)]
        private static extern unsafe int CST_GetLightTriMode(int* lightTriMode, CSTControllerHandleType CSTControllerHandle);

        [DllImport(CSTContorllerDll, CallingConvention = CallingConvention.Cdecl)]
        private static extern unsafe int CST_SetLightTriMode(int LightTriMode, CSTControllerHandleType CSTControllerHandle);

        [DllImport(CSTContorllerDll, CallingConvention = CallingConvention.Cdecl)]
        private static extern unsafe int CST_GetCamTriEdge(int* camTriEdge, CSTControllerHandleType CSTControllerHandle);

        [DllImport(CSTContorllerDll, CallingConvention = CallingConvention.Cdecl)]
        private static extern unsafe int CST_SetCamTriEdge(int camTriEdge, CSTControllerHandleType CSTControllerHandle);

        [DllImport(CSTContorllerDll, CallingConvention = CallingConvention.Cdecl)]
        private static extern unsafe int CST_GetLightState(int* lightState, CSTControllerHandleType CSTControllerHandle);

        [DllImport(CSTContorllerDll, CallingConvention = CallingConvention.Cdecl)]
        private static extern unsafe int CST_SetLightState(int lightState, CSTControllerHandleType CSTControllerHandle);

        [DllImport(CSTContorllerDll, CallingConvention = CallingConvention.Cdecl)]
        private static extern unsafe int CST_KeepAlive(CSTControllerHandleType CSTControllerHandle);
        ...
        public unsafe int ConnectIP(string ipAddress, int mTimeOut)
        {
        ...
        public unsafe int DestroyIpConnection()
        {
        ...
        /// <returns>SUCCESS——操作成功，ERROR_CONNECT——连接失败</returns>
        public unsafe int CreateSerialPort(int serialPortIndex)
        {
            fixed (CSTControllerHandleType* controllerHandle = &ControllerHandle)
            {
        ...
        /// </summary>
        /// <returns>SUCCESS——操作成功，ERROR_CLOSE——断开失败</returns>
        public unsafe int ReleaseSerialPort()
        {
        ...
        public unsafe int GetDigitalValue(int ChannelIndex, ref int Intensity)
        {
        ...
        public unsafe int SetDigitalValue(int ChannelIndex, int intensity)
        {
        ...
        public unsafe int SetMulDigitalValue(MulDigValItem[] MulDigValArray, int length)
        {
        ...
        public unsafe int GetStrobeValue(ref int StrobeValue, int ChannelIndex)
        {
        ...
        public unsafe int SetStrobeValue(int ChannelIndex, int strobeValue)
        {
        ...
        public unsafe int SetMulStrobeValue(MulStbValItem[] MulStbValArray, int length)
        {
        ...
        public unsafe int GetLightDelayValue(ref int LightDelayValue, int ChannelIndex)
        {
        ...
        public unsafe int SetLightDelayValue(int ChannelIndex, int lightDelayValue)
        {
        ...
        public unsafe int SetMulLightDelayValue(MulLigDelValItem[] MulLigDelValArray, int length)
        {
        ...
        public unsafe int GetCameraDelayValue(ref int CameraDelayValue, int ChannelIndex)
        {
        ...
        public unsafe int SetCameraDelayValue(int ChannelIndex, int cameraDelayValue)
        {
        ...
        public unsafe int SetMulCameraDelayValue(MulCamDelValItem[] MulCamDelValArray, int length)
        {
        ...
        public unsafe int GetIntCycleValue(ref int IntCycleValue)
        {
        ...
        public unsafe int SetIntCycleValue(int intCycleValue)
        {
        ...
        public unsafe int GetLightTriMode(ref int LightTriMode)
        {
        ...
        public unsafe int SetLightTriMode(int LightTriMode)
        {
        ...
        public unsafe int GetCamTriEdge(ref int CamTriEdge)
        {
        ...
        public unsafe int SetCamTriEdge(int camTriEdge)
        {
        ...
        public unsafe int GetLightState(ref int LightState)
        {
        ...
        public unsafe int SetLightState(int lightState)
        {
