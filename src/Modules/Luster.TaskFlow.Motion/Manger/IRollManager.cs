...
namespace Luster.TaskFlow.Motion.Interfaces
{
    ...
    public interface IRollManager
    {
        ...
        /// 工单更新
        /// </summary>
        event Action<TbRollInfo> OrderUpdateEvent;
        ...
        /// <returns></returns>
        bool HasOrder(bool isLeft,out string firstOrder);

        /// <summary>
        /// 更新工站
        /// </summary>
        /// <param name="orderNo">工单结束</param>
        void UpdateStation(string orderNo, string station);

        /// <summary>
        /// 更新卷料但
        /// </summary>
        void ClearUseNum(string orderNo);
        ...
        int GetUse(string orderNo);

        /// <summary>
        /// 更新已使用数量
        /// </summary>
        /// <param name="rollNo"></param>
        int UpdateUseNum(string rollNo);

        /// <summary>
        /// 获取当前工单信息
        /// </summary>
        /// <returns></returns>
        List<TbRollInfo> GetOrders();
    }
}