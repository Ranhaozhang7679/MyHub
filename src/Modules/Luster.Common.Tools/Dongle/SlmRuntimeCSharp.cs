...
#if DEBUG
        // 调试使用可调试的运行时库（允许调试）
        const string dll_name32 = "slm_runtime_dev.dll";
        const string dll_name64 = "slm_runtime_dev.dll";
#else
        // 正式发版，使用具有反调试功能的运行时库（不允许调试）
        const string dll_name32 = "slm_runtime.dll";
        const string dll_name64 = "slm_runtime.dll";
#endif
