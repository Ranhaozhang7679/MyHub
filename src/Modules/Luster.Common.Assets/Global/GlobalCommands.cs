...
namespace Luster.Common.Assets.Global
{
    public static class GlobalCommands
    {
        ...
        /// 取消交互命令
        /// </summary>
        public static CompositeCommand LangChangedCommand = new CompositeCommand();
        ...
        /// 取消交互命令
        /// </summary>
        public static CompositeCommand LoadBatchCloudCommand = new CompositeCommand();

        /// <summary>
        /// 隐藏所有labels
        /// </summary>
        public static CompositeCommand HideLabelsCommand = new CompositeCommand();

        /// <summary>
        /// 隐藏所有labels
        /// </summary>
        public static CompositeCommand ErrLabSetCommand = new CompositeCommand();

        /// <summary>
        /// 标签源数据隐藏
        /// </summary>
        public static CompositeCommand ErrLabSorHidCommand = new CompositeCommand();
        ...
        /// 批量添加测量项命令
        /// </summary>
        public static CompositeCommand AddMeasureObjCommand = new CompositeCommand();

        /// <summary>
        /// 批量增加点命令
        /// </summary>
        public static CompositeCommand AddBatchPointsCommand = new CompositeCommand();
        ...
        /// 执行批量导入点命令
        /// </summary>
        public static CompositeCommand OpenBatchGenPointsCommand = new CompositeCommand();

        /// <summary>
        /// 执行批量设置测量项命令
        /// </summary>
        public static CompositeCommand GenBatchMeasureCommand = new CompositeCommand();
        ...
        /// 测量项移动命令
        /// </summary>
        public static CompositeCommand MeasureObjMoveCommand = new CompositeCommand();

        /// <summary>
        /// 点移动命令
        /// </summary>
        public static CompositeCommand PointMoveCommand = new CompositeCommand();
