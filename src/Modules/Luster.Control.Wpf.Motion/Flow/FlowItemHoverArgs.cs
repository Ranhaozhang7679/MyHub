...
{
    public class FlowItemMoveArgs : RoutedEventArgs
    {
        /// <summary>
        /// 构造函数
        /// </summary>
        /// <param name="routedEvent"></param>
        public FlowItemMoveArgs(RoutedEvent routedEvent) : base(routedEvent)
        {
        }
        ...
        /// 要移动的索引
        /// </summary>
        public List<IFlowRender> MoveItems { get; set; }
