...
namespace Luster.Controls.Wpf.Motion.DragDrop
{
    /// <summary>
    ...
    public interface IDropListTarget
    {
        /// <summary>
        /// Determines whether the specified <paramref name="node" /> can be dropped here.
        /// </summary>
        ...
        /// <param name="effect">The drag/drop effect.</param>
        /// <param name="initialKeyStates">The initial drag/drop key states.</param>
        void Drop(IEnumerable<IDragSource> sourceitems, IDropListTarget targetPos, DropPosition dropPosition, DragDropEffect effect, DragDropKeyStates initialKeyStates);
    }
