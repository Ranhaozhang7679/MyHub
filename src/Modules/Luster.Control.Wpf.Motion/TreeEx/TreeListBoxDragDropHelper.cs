...
* 类 名 称:       TreeListBoxDragDropHelper
* 机器名称:       L05123-NB
* 命名空间:       Luster.Controls.Wpf.TreeListBox
* 文 件 名:       TreeListBoxDragDropHelper
* 创建时间:       2021/11/4 9:59:00
* 作    者:       luster
* 所属部门：      系统集成部
...
* 唯一标识：      31e8d901-fc70-4060-8483-e84c4302e4d9
* 登录用户:       darkliu
* 所 属 域:       L05123-NB
* 创建年份:       2021
* 修改时间:		  2021/11/4 9:59:00
* 修 改 人:		  luster
************************************************************************************/
#endregion
...
using Luster.Controls.Wpf.Motion.DragDrop;

namespace Luster.Control.Wpf.Motion.TreeEx
{
    /// <summary>
    ...
    public class TreeListBoxDragDropHelper
    {
        ...
        private void DropTargetPreviewDrop(object sender, DragEventArgs e)
        {
            ...
            if (draggedItems != null)
            {
                ...
                dropTarget.Drop(itemsToDrop, this.dropPosition, (DragDropEffect)e.Effects, (Luster.Controls.Wpf.Motion.DragDrop.DragDropKeyStates)this.initialKeyStates);
