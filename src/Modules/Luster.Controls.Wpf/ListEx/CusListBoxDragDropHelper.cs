...
using Luster.Controls.Wpf.DragDrop;

namespace Luster.Controls.Wpf.ListEx
{
    public class CusListBoxDragDropHelper
    {
        /// <summary>
        ...
        public static readonly DependencyProperty DragDropTemplateProperty =
            DependencyProperty.RegisterAttached(
                "DragDropTemplate",
                typeof(DataTemplate),
                typeof(CusListBoxDragDropHelper),
        ...
        /// The instance.
        /// </summary>
        private static CusListBoxDragDropHelper instance;

        /// <summary>
        /// The format.
        /// </summary>
        private readonly DataFormat format = DataFormats.GetDataFormat("CusListBox");
        ...
        /// </summary>
        private CusListBoxItem sourceItemContainer;

        /// <summary>
        /// The source items control.
        /// </summary>
        private CusListBox sourceItemsControl;
        ...
        /// </summary>
        private CusListBoxItem targetItemContainer;

        /// <summary>
        /// The target items control.
        /// </summary>
        private CusListBox targetItemsControl;
        ...
        private static CusListBoxDragDropHelper Instance
        {
            get
            {
                return instance ?? (instance = new CusListBoxDragDropHelper());
            }
        }
        ...
        private static void IsDragSourceChanged(DependencyObject obj, DependencyPropertyChangedEventArgs e)
        {
            ...
            if (dragSource != null)
            {
                ...
                if (object.Equals(e.NewValue, true))
                {
                    ...
                    dragSource.PreviewMouseRightButtonDown += Instance.DragSource_PreviewMouseRightButtonDown;
                    dragSource.PreviewMouseRightButtonUp += Instance.DragSource_PreviewMouseRightButtonUp;
        ...
        private void DragSource_PreviewMouseRightButtonUp(object sender, MouseButtonEventArgs e)
        {
            this.draggedData = null;
        }

        private void DragSource_PreviewMouseRightButtonDown(object sender, MouseButtonEventArgs e)
        {
            this.draggedData = null;
        }
        ...
        private void DecideDropTarget(DragEventArgs e)
        {
            ...
            if (targetItemsControlCount > 0)
            {
                ...
                this.targetItemContainer =
                    this.targetItemsControl.ContainerFromElement((DependencyObject)e.OriginalSource) as CusListBoxItem;
            ...
            {
                var dropTarget = this.targetItemContainer.DataContext as IDropListTarget;
        ...
        {
            this.sourceItemsControl = (CusListBox)sender;
            ...
            this.sourceItemContainer = visual != null
                                           ? this.sourceItemsControl.ContainerFromElement(visual) as CusListBoxItem
                                           : null;
        ...
        private void DropTargetPreviewDragEnter(object sender, DragEventArgs e)
        {
            ...
            this.targetItemsControl = (CusListBox)sender;
        ...
        private void DropTargetPreviewDrop(object sender, DragEventArgs e)
        {
            ...
            if (draggedItems != null)
            {
                ...
                dropTarget.Drop(itemsToDrop, dropTarget, this.dropPosition, (DragDropEffect)e.Effects, (DragDrop.DragDropKeyStates)this.initialKeyStates);
