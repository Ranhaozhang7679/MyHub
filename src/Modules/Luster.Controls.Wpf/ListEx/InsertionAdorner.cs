...
* 类 名 称:       InsertionAdorner
* 机器名称:       L05123-NB
* 命名空间:       Luster.Controls.Wpf.TreeListBox
* 文 件 名:       InsertionAdorner
* 创建时间:       2021/11/4 10:02:15
* 作    者:       luster
* 所属部门：      系统集成部
...
* 唯一标识：      7ac4d6e1-1b3c-40b7-8fbe-9f177e32943f
* 登录用户:       darkliu
* 所 属 域:       L05123-NB
* 创建年份:       2021
* 修改时间:		  2021/11/4 10:02:15
* 修 改 人:		  luster
************************************************************************************/
#endregion
...
namespace Luster.Controls.Wpf.ListEx
{
    ...
    public class InsertionAdorner : Adorner
    {
        ...
        static InsertionAdorner()
        {
            ...
            Pen = new Pen { Brush = Brushes.Gray, Thickness = 4 };
            Pen.Freeze();

            var firstLine = new LineSegment(new Point(0, -8), false);
            firstLine.Freeze();
            var secondLine = new LineSegment(new Point(0, 8), false);
            secondLine.Freeze();

            var figure = new PathFigure { StartPoint = new Point(8, 0) };
