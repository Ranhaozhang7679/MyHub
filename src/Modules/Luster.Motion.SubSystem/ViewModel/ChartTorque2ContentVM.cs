...
{
    public class ChartTorque2ContentVM : MotionVM, IDockContent
    {
        ...
        public ChartTorque2ContentVM()
        {


        }

        public ChartTorque2ContentVM(ICommonBus commonBus, IDialogService dialogService, IMotionController motionController, Dispatcher dispatcher, IMotionController mController, IMotionEngine motionEngine) : base(commonBus)
        {
        ...
        protected override void RegisterEvent(IEventAggregator bus)
        {
            ...
            bus.GetEvent<TorqueRegisterEvent>().Subscribe(screwDriver =>
            {
                ...
                if (!screwDriver.Name.Contains("2"))
                {
                    return;
                }
        ...
        /// 对应的Key
        /// </summary>
        public string Name => "TorqueForm2";

        /// <summary>
        /// 对应的区域
        /// </summary>
        public string RegionName { get; set; } = "ChartTorque2Content";
        #endregion
