...
{
    public class VisionConfigVM : MotionVM
    {
        /// <summary>
        /// 对话框服务
        /// </summary>
        ...
        public VisionConfigVM(ICommonBus commonBus,
        ...
        private void InitData()
        {
            ...
            if (webConfig == null || webConfig.IsEmpty())
            {
                ...
                // 保持对旧版本兼容
                var sysConfig = Path.Combine(commonBus.ProjInfo.GetProjConfigDir(), "SystemConfig.xml");
            ...
            if (webConfig != null)
            {
                ...
                DeviceIP = string.IsNullOrEmpty(webConfig.DeviceIP) ? GetVisionIPAddress() : webConfig.DeviceIP;
                //DeviceMac = GetMacAddress();
                DeviceMac = string.IsNullOrEmpty(webConfig.DeviceMac) ? GetVisionMacAddress() : webConfig.DeviceMac;
                ...
                SoftVersion = webConfig.SoftVersion != "" ? webConfig.SoftVersion : "Luster-03.07-10.01-NN.NN-NN.NN-250506"; // Luster-02.12-NN.NN-NN.NN-NN.NN_230410
        ...
        /// </summary>
        /// <returns></returns>
        private string GetVisionMacAddress()
        {
            string macAddress = "AA-BB-CC-DD-EE";
            ...
            {
                if (network.Name.ToUpper() == "VISION")
                {
        ...
        /// </summary>
        /// <returns></returns>
        private string GetVisionIPAddress()
        {
