...
{
    public class Press5ContentVM : MotionVM, IDockContent
    {
        ...
        public Press5ContentVM()
        {


        }

        public Press5ContentVM(ICommonBus commonBus, IDialogService dialogService, IMotionController motionController, Dispatcher dispatcher, IMotionController mController, IMotionEngine motionEngine) : base(commonBus)
        {
        ...
        protected override void RegisterEvent(IEventAggregator bus)
        {
            ...
            bus.GetEvent<PressRegisterEvent>().Subscribe(pressDriver =>
            {
                ...
                if (!pressDriver.Name.Contains("5"))
                {
                    return;
                }
        ...
        /// 对应的Key
        /// </summary>
        public string Name => "PressForm5";

        /// <summary>
        /// 对应的区域
        /// </summary>
        public string RegionName { get; set; } = "Press5Content";
        #endregion
