...
{
    public class Press4ContentVM : MotionVM, IDockContent
    {
        ...
        public Press4ContentVM()  
        {


        }

        public Press4ContentVM(ICommonBus commonBus, IDialogService dialogService, IMotionController motionController, Dispatcher dispatcher, IMotionController mController, IMotionEngine motionEngine) : base(commonBus)
        {
        ...
        protected override void RegisterEvent(IEventAggregator bus)
        {
           ...
           bus.GetEvent<CloseEvent>().Subscribe(() =>
            ...
            bus.GetEvent<PressRegisterEvent>().Subscribe(pressDriver =>  
            {
                ...
                if (!pressDriver.Name.Contains("4"))
                {
                    return;
                }
        ...
        /// 对应的Key
        /// </summary>
        public string Name => "PressForm4";

        /// <summary>
        /// 对应的区域
        /// </summary>
        public string RegionName { get; set; } = "Press4Content";
        #endregion
