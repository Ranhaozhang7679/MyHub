...
{
    public class Press1ContentVM : MotionVM, IDockContent
    {
        ...
        public Press1ContentVM()  
        {


        }

        public Press1ContentVM(ICommonBus commonBus, IDialogService dialogService, IMotionController motionController, Dispatcher dispatcher, IMotionController mController, IMotionEngine motionEngine) : base(commonBus)
        {
        ...
        protected override void RegisterEvent(IEventAggregator bus)
        {
           ...
           bus.GetEvent<CloseEvent>().Subscribe(() =>
            ...
            bus.GetEvent<PressRegisterEvent>().Subscribe(pressDriver =>  
            {
                ...
                if (!pressDriver.Name.Contains("1"))
                {
                    return;
                }
        ...
        /// 对应的Key
        /// </summary>
        public string Name => "PressForm1";

        /// <summary>
        /// 对应的区域
        /// </summary>
        public string RegionName { get; set; } = "Press1Content";
        #endregion
