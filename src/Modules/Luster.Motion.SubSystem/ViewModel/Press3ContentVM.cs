...
{
    public class Press3ContentVM : MotionVM, IDockContent
    {
        ...
        public Press3ContentVM()  
        {


        }

        public Press3ContentVM(ICommonBus commonBus, IDialogService dialogService, IMotionController motionController, Dispatcher dispatcher, IMotionController mController, IMotionEngine motionEngine) : base(commonBus)
        {
        ...
        protected override void RegisterEvent(IEventAggregator bus)
        {
           ...
           bus.GetEvent<CloseEvent>().Subscribe(() =>
            ...
            bus.GetEvent<PressRegisterEvent>().Subscribe(pressDriver =>  
            {
                ...
                if (!pressDriver.Name.Contains("3"))
                {
                    return;
                }
        ...
        /// 对应的Key
        /// </summary>
        public string Name => "PressForm3";

        /// <summary>
        /// 对应的区域
        /// </summary>
        public string RegionName { get; set; } = "Press3Content";
        #endregion
